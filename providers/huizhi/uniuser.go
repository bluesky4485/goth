...
var (
	AuthURL    = "https://uni.net.dstyun.com/oauth/authorize"
	TokenURL   = "https://uni.net.dstyun.com/api/hztech-auth/oauth/token"
	ProfileURL = "https://uni.net.dstyun.com/api/hztech-auth/oauth/user-info"
)
...
func NewCustomisedURL(clientKey, secret, callbackURL, authURL, tokenURL, profileURL string, scopes ...string) *Provider {
	p := &Provider{
		...
		providerName: "uniuser",
		headers: map[string]string{
			"Authorization":         "Basic " + base64.StdEncoding.EncodeToString([]byte(clientKey+":"+secret)),
...
func (p *Provider) FetchUser(session goth.Session) (goth.User, error) {
	...
	req.Header.Set("hztech-auth", "Bearer "+sess.AccessToken)
